...
const industries = [
  {
    ...
    solution: "Verion Engage intelligently maps talent to projects based on AI skill matching, while Verion ServiceWorks handles internal IT smoothly.",
  },
  {
  ...
  },
  {
    ...
    solution: "Verion DataWorks cleanses high-volume retail data instantly. Verion Trade Scheme models and automates complex promotional payouts. Verion Engage engages and retains frontline retail teams.",
  },
  {
