...
function CustomI({ stemColor, dotColor, size }: { stemColor: string; dotColor: string; size: number }) {
  ...
  return (
    <span style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", height: `${totalH}px`, position: "relative", verticalAlign: "bottom" }}>
...
export function PurpleVariant() {
  return (
    ...
    >
      ...
      >
        <span style={{ color: PURPLE, display: "inline-flex", alignItems: "center", gap: 0 }}>
          <span>Ver</span>
